...
import { useAddClassMutation, useUpdateClassMutation } from "../../services/api.service";
import { toast } from "react-toastify";

export default function ModelClass({ closeModelClass ,classEdit,gradeId}) {
  ...
  useEffect(() => {
    if(classEdit){
      ...
      setDescription(classEdit.description || "")
    }
  },[classEdit])
  
  const handleSubmit = (e) => {
    e.preventDefault();
    if (classEdit && classEdit._id) {
      updateClass({
        id: classEdit._id,
        name,
        description,
      ...
      addClass({
        ...
        setName("");
        setDescription("");
        toast.success("Đã thêm khóa học thành công!");
